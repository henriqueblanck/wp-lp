  ...
  const features = [
    {
      ...
      description: 'Deixe nossa equipe de especialistas criar fluxos automatizados personalizados para seu negócio, aumentando eficiência e resultados.'
    },
    {
      icon: <Users size={24} />,
      title: 'Multi-atendentes',
      description: 'Gerencie sua equipe de atendimento com eficiência, distribuindo conversas de forma inteligente e organizada.'
    },
    {
      icon: <Calendar size={24} />,
      title: 'Agendamentos',
      description: 'Sistema completo para que seus clientes agendem serviços diretamente pelo WhatsApp, facilitando conversões.'
    },
    {
      icon: <BarChart3 size={24} />,
      title: 'Relatórios Detalhados',
      description: 'Acompanhe métricas importantes do seu atendimento e performance para tomar decisões baseadas em dados.'
    }
  ];
